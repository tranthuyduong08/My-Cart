...
public class AddProductAdapter extends RecyclerView.Adapter<AddProductAdapter.MyHolder> implements Filterable {
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new MyHolder(itemView, context);
    }
            ...
            btnAddToCart.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(isAdded || isUpdated){
                        ...
                        Toast.makeText(context, "Added product fail", Toast.LENGTH_SHORT).show();
                    }
                }
            });
